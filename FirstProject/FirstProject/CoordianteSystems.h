...
int RunCoordinateSystems()
{
    ...
    // ------------------------------------
    Shader ourShader("vsfs/6.3.coordinate_systems.vs", "vsfs/6.3.coordinate_systems.fs");
    ...
    std::string filename = "resources/textures/container.jpg";
